...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/06 10:15:03 by vlvereta          #+#    #+#             */
/*   Updated: 2018/06/06 10:18:32 by vlvereta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define D0_512(x) (ROTR_64(x, 1) ^ ROTR_64(x, 8) ^ ((x) >> 7))
# define D1_512(x) (ROTR_64(x, 19) ^ ROTR_64(x, 61) ^ ((x) >> 6))

# define ROTR_64(x, n) (((x) >> (n)) | ((x) << (64 - (n))))

static uint64_t	g_t2[8];

static uint64_t	g_sha512_h[8] = {
